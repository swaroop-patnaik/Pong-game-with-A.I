...
def eval_genomes(genomes, config):
    ...
    for i, (genome_id1, genome1) in enumerate(genomes):
        ...
        for genome_id2, genome2 in genomes[i+1:]:
            genome2.fitness = 0 if genome2 == None else genome2.fitness
            game = Pong_Game(window, width, height)
...
if __name__ == "__main__":
    local_dir = os.path.dirname(__file__) #dirname of the current file
